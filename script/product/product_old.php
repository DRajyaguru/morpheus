...
$middle="customer/middle/product/product_old.tpl";
...
$product_data = $db->getOne('product');
...
$localvars = array("top"=>$top,"bottom"=>$bottom,"middle"=>$middle,"title"=>$title,"product_data"=>$product_data,"product_category_data"=>$product_category_data,"product_extrafields_data"=>$product_extrafields_data,"product_exist"=>$product_exist);
