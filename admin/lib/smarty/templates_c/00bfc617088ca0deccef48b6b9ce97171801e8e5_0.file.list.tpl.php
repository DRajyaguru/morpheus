<?php
/* Smarty version 4.1.0, created on 2022-03-03 06:30:46
  from 'D:\wamp\www\morpheus\skin\admin\middle\dashboard\list.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62206096b823c1_82087396',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '00bfc617088ca0deccef48b6b9ce97171801e8e5' => 
    array (
      0 => 'D:\\wamp\\www\\morpheus\\skin\\admin\\middle\\dashboard\\list.tpl',
      1 => 1646288893,
      2 => 'file',
    ),
  ),
...
function content_62206096b823c1_82087396 (Smarty_Internal_Template $_smarty_tpl) {
?><!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="container-xxl" id="kt_content_container">
                ...
                <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-bold fs-6">Total Earnings of January</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                    </div>
                    ...
                    <div class="card-body pt-2 pb-4 d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column content-justify-center w-100">
                            ...
                            <div class="d-flex fs-6 fw-bold align-items-center">
                                <!--begin::Bullet-->
                                <div class="bullet w-8px h-6px rounded-2 bg-blue-dark me-2"></div>
                                <!--end::Bullet-->
                                <!--begin::Label-->
                                <div class="text-gray-500 flex-grow-1 me-1">Real Estate</div>
                                <!--end::Label-->
                                <!--begin::Stats-->
                            ...
                            <div class="d-flex fs-6 fw-bold align-items-center my-3">
                                <!--begin::Bullet-->
                                <div class="bullet w-8px h-6px rounded-2 bg-blue-light me-2"></div>
                                <!--end::Bullet-->
                                <!--begin::Label-->
                                <div class="text-gray-500 flex-grow-1 me-1">Business</div>
                                <!--end::Label-->
                                <!--begin::Stats-->
                            ...
                            <div class="d-flex fs-6 fw-bold align-items-center">
                                <!--begin::Bullet-->
                                <div class="bullet w-8px h-6px rounded-2 me-2" style="background-color: #E4E6EF"></div>
                                <!--end::Bullet-->
                                <!--begin::Label-->
                                <div class="text-gray-500 flex-grow-1 me-1">Sports</div>
                                <!--end::Label-->
                                <!--begin::Stats-->
                    ...
                    <div class="card-body d-flex flex-column justify-content-end pe-0">
                        ...
                        <div class="symbol-group symbol-hover flex-nowrap">
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Barry Walter">
                                <span class="symbol-label bg-warning text-inverse-warning fw-bolder">B</span>
                            </div>
                ...
                <div class="card card-flush overflow-hidden h-md-100">
                    ...
                    <div class="card-header py-5">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-dark">Sales of January</span>
        ...
        <div class="row gy-5 g-xl-10">
            <!--begin::Col-->
            <div class="col-xl-12 mb-12 mb-xl-10">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                            ...
                            <tbody class="fw-bolder text-gray-600">
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="text-dark text-hover-primary">#VIDEO-346</a>
                                    </td>
                                    <td class="text-end">28 February 2022, 6:56 am</td>
                                    <td class="text-end">
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="text-dark text-hover-primary">#VIDEO-047</a>
                                    </td>
                                    <td class="text-end">26 February 2022, 6:04 am</td>
                                    <td class="text-end">
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="text-dark text-hover-primary">#VIDEO-678</a>
                                    </td>
                                    <td class="text-end">25 February 2022, 2:56 am</td>
                                    <td class="text-end">
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="text-dark text-hover-primary">#VIDEO-534</a>
                                    </td>
                                    <td class="text-end">20 February 2022, 6:56 am</td>
                                    <td class="text-end">
                                        <a href="" class="text-dark text-hover-primary">Sean Bean</a>
                                    </td>
                                    <td class="text-end">$119.00</td>
                                    <td class="text-end">
                                        <span class="badge py-3 px-4 fs-7 badge-light-success">Downloaded</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="#" class="text-dark text-hover-primary">#VIDEO-035</a>
                                    </td>
                                    <td class="text-end">18 February 2022, 6:56 am</td>
                                    <td class="text-end">
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="text-dark text-hover-primary">#VIDEO-567</a>
                                    </td>
                                    <td class="text-end">15 February 2022, 6:56 am</td>
                                    <td class="text-end">
