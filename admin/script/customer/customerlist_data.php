...
$fields  = array('c.customer_id','c.first_name','c.last_name','c.email_id','c.total_credits','c.status');
...
$columns = array(
   ...
   array('db' => 'first_name',	
	      'dt' => 1,
		  'formatter' => function( $d, $row ) {
		  	return '<a href="#" class="text-gray-800 text-hover-primary mb-1" customer-filter="first_name">'.$row['first_name'].'</a>';
		  }),
