...
<section class="checkout_section">
 <form method="post" action="index.php?file=order/download" class="checkout_form general_form_input" id="checkout_form">
 <input type="hidden" name="complete_checkout" value="Y" />
 <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
           <div class="form-group">
            ...
            <input type="text" class="form-control" name="first_name" id="first_name" value="{$customer_data.first_name}">
           </div>
          </div>
       	  <div class="col-md-6">
           <div class="form-group">
            <label for="Last Name">Last Name <span class="required">*</span></label>
            <input type="text" class="form-control" name="last_name" id="last_name" value="{$customer_data.last_name}">
           </div>
          </div>
          <div class="col-md-6">
           <div class="form-group">
          ...
          <div class="col-md-6">
           <div class="form-group">
            ...
            <input type="text" class="form-control" name="phone_no" id="phone_no" value="{$customer_data.phone_no}">
           </div>
          </div>
          <div class="col-md-6">
           <div class="form-group">
            <label for="Address1">Address1 <span class="required">*</span></label>
            <input type="text" class="form-control" name="address1" id="address1" value="{$customer_data.address1}">
           </div>
          </div>
          <div class="col-md-6">
           <div class="form-group">
            <label for="Address2">Address2</label>
            <input type="text" class="form-control" name="address2" id="address2" value="{$customer_data.address2}">            
           </div>
          </div>          
          <div class="col-md-6">
           <div class="form-group">
            ...
            <select class="form-control checkout-country" name="country" id="country" value="{$customer_data.country}">
          ...
          <div class="col-md-6">
           <div class="form-group state-checkout">
            <label for="State">State <span class="required">*</span></label>
            <input type="text" class="form-control state-text" name="state" id="state" value="{$customer_data.state}">
            <select class="form-control checkout-state" name="state" id="checkout-state" value="{$customer_data.state}">
          ...
          <div class="col-md-6">
           <div class="form-group">
            ...
            <input type="text" class="form-control" name="city" id="city" value="{$customer_data.city}">
           </div>
          </div>
          <div class="col-md-6 zip">
           <div class="form-group">
            <label for="ZipCode">ZipCode <span class="required">*</span></label>
            <input type="text" class="form-control" name="zipcode" id="zipcode" value="{$customer_data.zipcode}">
           </div>
          </div>
          <div class="col-md-12 license-div">
          </div>
          <div class="col-md-12">
           <div class="form-group">
            <label for="Notes">Notes </label>
            <textarea class="form-control mb-0" name="notes" rows="4"></textarea>
           </div>
          </div>
      ...
      <div class="cart-total-details">
       ...
       <div class="cart-order-summery">
        ...
        <div class="total-purchase-credits">
         ...
         <span><img src="assets/img/token.png"> <span class="total-buy-credits">{$checkout_info.total_credits}</span></span> 
        </div>
      </div>
      <div>
       <input type="submit" value="Complete checkout" name="btn_payment" class="morpheus_btn btn-payment btn btn-primary mt-2"> 
      </div>
      </div>
     </div>
    </div>
