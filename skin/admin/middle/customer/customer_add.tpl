...
<div class="content d-flex flex-column flex-column-fluid" >
    ...
    <div class="container-xxl" id="kt_content_container">
        <!--begin::Form-->
        <form id="add_customer_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="index.php?file=customer/customer_list">
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body text-center pt-0 fv-row">
                        <!--begin::Label-->
                        <label class="form-label" style="font-size:30px">{if $customer_list.total_credits neq ''}{$customer_list.total_credits}{else}0{/if}</label>
                        <!--end::Label-->
                    </div>
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="tab-content">
                    <!--begin::Tab pane-->
                    <div class="tab-pane fade show active" id="add_customer_general" role="tab-panel">
                ...
                <div class="d-flex justify-content-end">
                    <!--begin::Button-->
                    <a href="index.php?file=customer/customer_list" id="add_customer_cancel" class="btn btn-light me-5" >Cancel</a>
                    <!--end::Button-->
                    <!--begin::Button-->
