...
<div id="kt_header" style="" class="header bg-white align-items-stretch">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center" id="kt_header_wrapper">
            <!--begin::Page title-->
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{literal}{default: '#kt_content_container', lg: '#kt_header_wrapper'}{/literal}">
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-1 fs-3 lh-1">{$top_title}</h1>
                <!--end::Heading-->
            </div>
            <!--end::Page title=-->
        </div>
